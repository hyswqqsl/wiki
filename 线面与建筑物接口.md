...
22. 获取建筑物详情，/shape/build/details/{id},GET
   ...
   * 返回：
      * OK：返回json
         * {id:xxx,remark:{name:xxx,alias:xxx,attribute:[{id:xxx,name:xxx,unit:xxx,type:xxx,value:xxx,},{...}]}, waterResource:{name:xxx,alias:xxx,attribute:[{id:xxx,name:xxx,unit:xxx,type:xxx,value:xxx,},{...}]}, controlSize:{name:xxx,alias:xxx,attribute:[{id:xxx,name:xxx,unit:xxx,type:xxx,value:xxx,},{...}]}, groundStress:{name:xxx,alias:xxx,attribute:[{id:xxx,name:xxx,unit:xxx,type:xxx,value:xxx,},{...}]}, component:{name:xxx,alias:xxx,child:[{name:xxx,attribute:[{id: xxx, name: xxx, alias: xxx, type: xxx, value: xxx, selects: ["xxx", "xxx"]}, {...}]}], {...}}}
      * DATA_NOEXIST: 建筑物不存在
