...
![Main](/uploads/6de739c38e87ebc59d9aaac62478c8be/Main.png)
...
6. 获取图形线面详情, /shape/shape/details/{id},GET
   ...
   * 返回：
       * OK
          ...
          * 线面coors,如果点下建筑物，需要把建筑物名发过来, coors:[{id:xxx,lat:xxx,lon:xxx,ele:xxx, buildName:xxx,buildRemark:xxx}, {...}]
          * childType：剖面类型
...
7. 新建图形线面, /shape/shape/create, POST
   ...
   * 返回：
      * OK，新建成功
         * 取得线面json
         * 线面属性：{id:xxx,type:xxx,remark:xxx}
         * 线面coors: coors:[{id:xxx,lat:xxx,lon:xxx}, {...}]
...
11. 取得图形线面下某点详情,/shape/coordinate/details/{id},GET
   ...
   * 返回：
      * OK：点属性，高程组，建筑物基本信息
         * {id:xxx,lat:xxx,lon:xxx,elevations:[{top-ele:xxx,name:xxx,value:xxx},{...}],build:{id:xxx,type:xxx,childType:xxx,name:xxx}}
      * DATA_NOEXIST: 点不存在
      * DATA_REFUSE：不是自己的线面下的点   
12. 编辑图形线面下某点高程组，/shape/coordinate/elevation/edit,POST
   ...
   * 返回：
      ...
      * DATA_NOEXIST: 点不存在
      * DATA_REFUSE：不是自己的线面下的点                
13. 新建图形线面剖面属性,/shape/shape/attribute/create,POST
...
22. 获取建筑物详情，/shape/build/details/{id},GET
   ...
   * 返回：
      * OK：返回json
         * {id:xxx,name:xxx,alias:xxx,type:xxx,coordinate:[{name:xxx,unit:xxx,type:xxx},{...}]}, waterResource:{name:xxx,alias:xxx,attribute:[{id:xxx,name:xxx,unit:xxx,type:xxx,value:xxx,},{...}]}, controlSize:{name:xxx,alias:xxx,attribute:[{id:xxx,name:xxx,unit:xxx,type:xxx,value:xxx,},{...}]}, groundStress:{name:xxx,alias:xxx,attribute:[{id:xxx,name:xxx,unit:xxx,type:xxx,value:xxx,},{...}]}, component:{name:xxx,alias:xxx,child:[{name:xxx,attribute:[{id: xxx, name: xxx, alias: xxx, type: xxx, value: xxx, selects: ["xxx", "xxx"]}, {...}]}], {...}}}
      * DATA_NOEXIST: 建筑物不存在
...
23. 编辑建筑物，/shape/build/edit, POST
   ...
   * 参数：
      * id:建筑物id
      * attributes:[{id:xxx,alias:xxx,value:xxx},{alias:xxx,value:xxx, dynAttributes:[{id:xxx,alias:xxx,value:xxx},{...}]},{...}]
   * 返回：
      * OK，编辑成功
      * DATA_NOEXIST: 建筑物不存在
      * DATA_REFUSE：不是自己的建筑物        
24. 新建建筑物动态属性，/shape/build/dyn/create, POST
	* 动态属性单独添加
	* 参数:
	  * id: 建筑物id
	  * alias: 动态组alias
    * 返回：
	  * OK, 返回动态属性json，[{name:xxx,alias:xxx}, {...}]
      * DATA_NOEXIST: 建筑物或动态组不存在
25. 删除建筑物动态属性, /shape/build/dyn/remove, POST
	* 动态属性单独删除
...
4. bim获取建筑物信息 /testBuild/bim/build?type&&childType   get
   ...
   * 不需要alias
   * 其中propertyType含义是属性分类，比如坐标coordinate，水利要素waterResource，控制尺寸controlSize，
   ...
   * 参数：
      ...
      * childType: 建筑物子类型
   * 返回：
      * OK，返回建筑物属性，{coordinate:{name:xxx,unit:xxx,type:xxx,value:xxx,fieldName:xxx,objName:xxx}, waterResource:{...}, controlSize:{...}, groundStress:{...},component:{...}}
