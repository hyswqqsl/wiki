...
2. 取得线面分类及类型,包括显示类型, /shape/shape/type/download,GET
   ...
   * 返回：OK，
   * [{
	   * classify:"CANAL", classifyC:"渠系建筑", displayType:"LINE", displayTypeC:"线", spapes:[{type:"GSGG", typeC:"供水干管"}]
   * }, {...}]
...
6. 获取图形线面详情, /shape/shape/details/{id},GET
   ...
   * 返回：
       * OK
          ...
          * 线面coors,如果点下建筑物，需要把建筑物名发过来, coors:[{id:xxx,lat:xxx,lon:xxx,elevation:[{xxx},{...}], buildType:xxx,buildTypeC, buildChildType, buildChidlTypeC,buildRemark:xxx, }, {...}]
          * childTypes：剖面类型
...
15. 取得内业的建筑物分类及类型,/shape/build/internal/type/list,GET
	...
	* 返回：OK，
	  ...
	  * classify:"WATER_SOURCE_BUILD", classifyC:"水源建筑物", builds:
		* [
		  * {type:"QS", typeC:"泉室"}
		  * {type:"FSZ", typeC:"水闸", childTypes:[{type:"KAICSSZ", typeC:"开敞式水闸"}, {...}]}
		  * ] 
	  * }, {...}]
