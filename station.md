...
1. 获取测站列表,包括分享的测站,/station/list,GET
    ...
    * 参数：无
    * 返回:
       * OK,返回json，[{id:xxx, name:xxx, type:xxx, coor:xxx, picture:xxx, userId:xxx, shares:xxx, cooperate:xxx,sensors:[{id:xxx, name:xxx, code:xxx}, {...}], cameras:[{id:xxx,name:xxx,code:xxx}, {...}]}, {...}}]
...
12. 仪表删除自定义属性: /station/sensor/extra/delete/{id},DELETE
    * 参数：
       * id：自定义属性id
     * 返回：
        * OK，添加成功
