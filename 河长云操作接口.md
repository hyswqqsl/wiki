...
1. 登录发送验证码: /hzUser/login/getLoginVerify,GET
    ...
    * **角色：无**
    * 河长登录时，取得验证码
    * 河长对应的行政区不在regionCode范围内，返回DATA_NOEXIST
    * 参数：
        * phone:登录手机号
        * regionCode： 移动端平台行政区编码
    * 返回：
        * OK:发送成功
...
3. 移动端原生取得河段的面坐标,/riverSegment/phone/coors,GET
    * **app端使用**
    * 参数：
        * id:河段id
        * token:原生访问传递的token
...
5. 河长办通过水利一张图查看河道列表，/riverSegment/hzb/map/lists
   * **web端使用**
   * 角色：各级河长办人员
   * 市级河长办返回河段信息：[{id，name，coor(中心坐标), taskNum(年总任务数)， taskUnHandleNum(未处理任务数)，reportNum(年总报告数)， reportUnHandleNum(未处理报告数)， matterNum(年总事件数), matterUnHandleNum(未归档事件数), cruiseNum(本月巡河次数)}]
   * 县级河长办返回河段信息：[{id，name，coor(中心坐标), taskNum(年总任务数)， taskUnHandleNum(未处理任务数)，reportNum(年总报告数)， reportUnHandleNum(未处理报告数)， matterNum(年总事件数), matterUnHandleNum(未归档事件数), cruiseNum(本月巡河次数)}]
   * 乡级河长办返回河段信息：[{id，name，coor(中心坐标), taskNum(年总任务数)， taskUnHandleNum(未处理任务数)，reportNum(年总报告数)， reportUnHandleNum(未处理报告数)， cruiseNum(本月巡河次数)}]
   * 年投诉列表,complaints
   * 参数：
       * 无
   * 返回：
       * OK，河长办本级河段和下级河段列表，{riverSegments：[{...}, {...}], complaints:{...}} 
...
1. 河长办用户登录,/hzbUser/login,POST
    ...
    * 参数: 
        ...
        * cookie：cookie
    * 返回：
        * OK:登录成功,返回河长办用户属性+河长办属性，{name:xxx,...,hzb:{name：xxx,regionCode:xxx,...}, qqslBucket:xxx, qqslimageBucket:xxx, weChatMenus:[{enum:0, title:新闻动态},{}], articleMenus:[{enum:0, title:新闻动态},{...}]}
...
16. 市级直接承办事件,/matter/city/handle,POST
    ...
    * 没有sourceId的，登录事件时已经传递河流id，得到市级河段，存到riverSegmentId          
    * 事件改为状态是交办
    * 事件的河段id此时确定
    * 如果河流不属于这个市河长办，返回错误     
    * 如果河流不属于这个市河长办，返回错误
...
1. 登录发送验证码: /patrolUser/login/getLoginVerify,GET
    ...
    * **角色：无**
    * 巡河员登录时，取得验证码
    * 巡河员对应的行政区不在regionCode范围内，返回DATA_NOEXIST
    * 参数：
        * phone:登录手机号
        * regionCode： 移动端平台行政区编码
    * 返回：
...
2. 登录：/patrolUser/login,POST
    ...
    * 参数：
        * code:验证码
    * 返回:
        * OK:登录成功,返回巡河员详情，{name:xxx,location:xxx,phone:xx,riverSegment:{id,name:xx,length:xx,beginStation:xx,endStation:xx,riverName:xx,regionId,regionName:xx},upHzUser:{id,name:xx,regionId,regionName:xx.phone:xx,job:xx,type:xx}, hzb:{name,regionId,regionName,remark,phone},  qqslBucket:xxx, qqslimageBucket:xxx, weChatMenus:[{enum:0, title:新闻动态},{}], articleMenus:[{enum:0, title:新闻动态},{...}]}
        * 4041: CODE_INVALID 验证码过期
        * 4042: CODE_ERROR 验证码输入错误
