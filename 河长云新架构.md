...
2. 登录：/hzUser/login,POST
    ...
    * 参数：
        * code:验证码 
    * 返回:
        * OK:登录成功,返回河长详情，管辖的河段 {name:xx,regionId,regionName,phone:xx,job:xx,type:xx,riverSegments:[{id,name:xx,length:xx,beginStation:xx,endStation:xx,riverName:xx,regionId,regionName:xx},{...}], qqslBucket:xxx, qqslimageBucket:xxx, unit:{id:xxx, name:xxx, type:xxx, typeC:xxx}, weChatMenus:[{enum:0, title:新闻动态},{}], articleMenus:[{enum:0, title:新闻动态},{...}]}
        * 4041: CODE_INVALID 验证码过期
        * 4042: CODE_ERROR 验证码输入错误
...
13. 取得河长通讯录，/hzUser/contact/book,GET
   ...
   * 参数：无
   * 返回:
       * OK,格式：{parentHzUsers:[{id:xxx,name:xxx,phone:xxx,job:xxx},{...}], childHzUsers:[...], siblingHzUsers:[...]} 
